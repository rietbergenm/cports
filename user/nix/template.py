...
def _(self):
    self.depends = [
        "pc:nlohmann_json!nlohmann-json",
        "pc:libgit2!libgit2-devel",
        "pc:libarchive!libarchive-devel",
        "pc:libcurl!curl-devel",
        "pc:libseccomp!libseccomp-devel",
        "pc:sqlite3!sqlite-devel",
        "pc:bdw-gc!gc-devel",
        "pc:libcrypto!openssl-devel",
        "pc:libsodium!libsodium-devel",
        "pc:libbrotlicommon!brotli-devel",
        "pc:libbrotlidec!brotli-devel",
        "pc:libbrotlienc!brotli-devel",
        "pc:lowdown!lowdown-devel",
